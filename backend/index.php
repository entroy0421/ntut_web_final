...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card pull-up ecom-card-1 bg-white">
            <div class="card-content ecom-card2 height-180">
                <h5 class="text-muted warning position-absolute p-1">Visit Stats</h5>
                <div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <p class="card-text">Here is admin panel! Admin users are allow to do anything on the website, including create/update/list/delete both users and posts.</p>
                        <p class="card-text">On the left side, the sidebar leads you to the right place you want! Now try to click them and find out what admin users can do!</p>
                    </div>
                </div>
            </div>
    </div>
